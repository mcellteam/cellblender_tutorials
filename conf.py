...
# -*- coding: utf-8 -*-
#
# mcell_tutorial documentation build configuration file, created by
...
html_title = 'MCell and CellBlender Tutorials'
...
htmlhelp_basename = 'mcell_tutorialdoc'
...
latex_documents = [
  ('index', 'mcell_tutorial.tex', 'MCell Tutorial',
   'Jacob Czech', 'manual'),
]
...
man_pages = [
    ('index', 'mcell_tutorial', 'mcell_tutorial Documentation',
     ['Jacob Czech'], 1)
]
...
texinfo_documents = [
  ('index', 'mcell_tutorial', 'mcell_tutorial Documentation',
   'Jacob Czech', 'mcell_tutorial', 'One line description of project.',
   'Miscellaneous'),
]
...
def setup(sphinx):
    try:
        ...
        print("Syntax highlighting is unavailable. Try 'pip install "
              "Pygments==2.0.2'")
